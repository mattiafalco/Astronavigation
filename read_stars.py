""" This program reads the star catalogue 'comp_obs.csv' then evaluates the deflection
generated by some objects for each star in the catalogue.
...
jup.pos = cartesian(258.09813, -22.364378)*jup.dist
