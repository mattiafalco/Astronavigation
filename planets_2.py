...
class SolarSystem(object):
    ...
    def __init__(self, ephemerides=False):
        ...
        if not ephemerides:
            p = [0, 778412010, 1426725400, 2870972200, 4498252900]
            v = [0, 13.0697, 9.6724, 6.8352, 5.4778]
            # m = [132712e6, 126.687e6, 37.931e6, 5.7940e6, 6.8351e6]
            m = [1.32712440017987e11, 1.26712767863e8, 3.79406260630e7, 5.79454900700e6, 6.83653406400e6]
